...
- New roles (E = easy, M = medium, H = hard):
    ...
    - (H) timewarper: when he taps, sensitivity for every player is changed like fast speed in speedShift. Every player that dies in that mode gives him 2 points. He can take someone off guard with this skill
