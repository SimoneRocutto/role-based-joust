...
│   │
│   ├── pages/
│   │   ├── JoinView.tsx            # /join - Name entry + join lobby
│   │   ├── PlayerView.tsx          # /player - Main controller interface
│   │   └── DashboardView.tsx       # /dashboard - Admin scoreboard
│   │
│   ├── components/
│   │   ├── player/
│   │   │   ├── PlayerNumber.tsx           # Giant number display
│   │   │   ├── HealthBackground.tsx       # Colored bg based on health
│   │   │   ├── StatusEffects.tsx          # Active effects display
│   │   │   ├── TargetDisplay.tsx          # "Target: #3" indicator
│   │   │   └── ConnectionStatus.tsx       # Connected/reconnecting dot
│   │   │
│   │   ├── dashboard/
